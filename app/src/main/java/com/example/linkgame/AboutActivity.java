...
public class AboutActivity extends AbsAboutActivity {
    ...
    protected void onItemsCreated(@NonNull Items items) {
        ...
        items.add(new Contributor(R.drawable.owl, "周扬", "co-Developer & co-Designer", "https://github.com/SiwenZss"));
        items.add(new Category("开源库引用"));
        items.add(new License("响指连连看","三金",License.APACHE_2,"https://github.com/Lsj425"));
